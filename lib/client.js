window.__ModuleLoader__.load({
	id: "@bittersmilezzz/dsh-asr-voice",
	factory: (require) => {
		var module = { exports: {} };
...
`;
		...
		*/
		const ASR_VOICE_NS = "dsh-asr-voice";
		...
		*/
		function bindConfigScope(forms) {
			const scope = forms.get(ASR_VOICE_NS);
			voiceScope = scope;
			const applySnapshot = () => {
		...
		function pickActiveProvider(cloud) {
		...
		*  如刷新/全屏被 preventDefault 接管，是用户自选的配置），故保留。 */
		...
		function matchHotkey(e, spec) {
			...
			const ctrlOk = (e.ctrlKey || e.metaKey) === (spec.ctrl || spec.meta);
		...
		*  回环地址不需要警告：流量不出本机。 */
		function isInsecureBaseUrl(url) {
		...
		function Field({ title, desc, control, labelAs = "label" }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: labelAs === "span" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*  本地 string state 允许逐字输入 "0." 等中间态，blur 时 clamp 回写。 */
		function NumberRow({ title, desc, value, onChange, min, max, step = 1 }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
				title,
				desc,
				control: ({ controlId }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*  并把焦点移到新选中项（WAI-ARIA radiogroup 惯例：选中随焦点）。 */
		function Chips({ items, label, t }) {
			...
			const move = (from, delta) => {
				...
				if (target === void 0 || target.disabled === true) return;
				target.onSelect();
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				role: "radiogroup",
				"aria-label": label,
				children: [items.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					ref: (el) => {
		...
		function HotkeyRecorder({ inputId, value, onChange, t }) {
		...
		*  （parseHotkey 同口径拒绝，两端一致）。 */
		...
		function VoiceSettingsCard({ t, view }) {
			...
			if (view === "summary") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: t("cardCopy") });
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
				className: "dshav-card" + (open || pageView ? " dshav-card-open" : "") + (pageView ? " dshav-card-page" : ""),
				children: [pageView ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					type: "button",
				...
				}), open || pageView ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: "dshav-body" + (pageView ? " dshav-body-page" : ""),
					children: [
								...
								children: [
									cloudMode ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextRow, {
											...
											value: provider.name,
											onChange: (v) => {
												edit((c) => patchProvider(c, provider.id, { name: v }));
												setTested(null);
											}
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TextRow, {
											...
											onChange: (v) => {
												edit((c) => patchProvider(c, provider.id, { baseUrl: v }));
												setTested(null);
											}
										}),
										isInsecureBaseUrl(provider.baseUrl) ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
											className: "dshav-warn",
											role: "alert",
											children: t("insecureBaseUrl")
										}) : null,
										...
										draft.asr.cloud.providers.length > 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
											...
											labelAs: "span",
											control: ({ controlId, labelId }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Field, {
										title: t("hotkeyLabel"),
										desc: t("hotkeyDesc"),
										control: ({ controlId }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(HotkeyRecorder, {
											inputId: controlId,
		...
		* 规则的两份实现——改一处不必同步另一处。
		*/
		function appendDraftText(existing, text) {
		...
		*/
		function resolveEngine(provider, webSpeechSupported, cloudReady) {
		...
		* recoverable 缺省 true——同步启动抛错路径没有错误码，按「可兜底」处理（与原 catch 分支一致）。 */
		function shouldFallbackToCloud(engine, provider, cloudReady, recoverable = true) {
		...
		*  函数，node --test 直跑源码不受影响。 */
		function createPcmAudioContext(latencyHint) {
			...
			try {
				return latencyHint === void 0 ? new AudioCtor({ sampleRate: PCM_SAMPLE_RATE }) : new AudioCtor({
					latencyHint,
					sampleRate: PCM_SAMPLE_RATE
				});
			} catch {
				return latencyHint === void 0 ? new AudioCtor() : new AudioCtor({ latencyHint });
			}
		}
		...
		* 且系统资源有限，反复 new/close 会抖动；录音开始接新流、结束断流即可。 */
		...
		function createCloudRecorder(language, onError, behavior) {
			...
			*   executor 里的 reject，无需在此捕获）。 */
			...
			const captureDiagnostic = (blob) => {
				if (blob.size <= 0) return;
				fetch("/api/asr-voice/transcribe?capture=1", {
					method: "POST",
		...
		*  （48k→16k 无抗混叠低通，会伤识别率，见 createPcmAudioContext）。 */
		...
		async function postHostApi(path, init, timeoutMs, label, externalSignal) {
			const controller = new AbortController();
			...
			try {
				...
				const data = await res.json().catch(() => ({}));
				if (!res.ok || data.ok !== true || typeof data.text !== "string") throw new Error(data.reason || `${label} failed`);
				return data.text;
			} catch (error) {
		...
		async function transcribeViaHost(blob, language, externalSignal) {
			const lang = resolveLang(language);
			return postHostApi(`/api/asr-voice/transcribe${lang ? `?language=${encodeURIComponent(lang)}` : ""}`, {
				headers: { "content-type": blob.type || "audio/webm" },
				body: blob
		...
		*  整词删除会把 "I like this"→"I this"、"as well as"→"as as" 这类正常句子削坏。 */
		...
		async function llmOptimize(text, target, externalSignal) {
			...
			return postHostApi("/api/asr-voice/optimize", {
		...
		function tween(target, to, from) {
			...
			*  否则 `repeat: Infinity, delay: .24` 这类循环每圈都白等 delay。 */
			...
			const tick = (now) => {
				if (killed) return;
				if (startTime === null) {
					startTime = now + (delayApplied ? 0 : delay * 1e3);
					delayApplied = true;
					onStart?.();
				}
				if (now < startTime) {
		...
		* 仅高度由 CSS 变量 --level 在帧循环驱动）。 */
		const SpectrumBars = react.memo(() => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react.Fragment, { children: Array.from({ length: 12 }, (_, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "dshav-bar",
			style: { "--bar": String(.35 + i / 11 * .65) }
		}, i)) }));
		//#endregion
		//#region src/client/long-press.ts
		const defaultTimers = {
		...
		function createLongPressGate(options) {
			...
			const press = () => {
				...
				fired = false;
				suppressClick = false;
				if (options.isLongPressAllowed !== void 0 && !options.isLongPressAllowed()) return;
				timer = timers.set(() => {
					timer = null;
					fired = true;
					options.onLongPress();
		...
		//#endregion
		//#region src/client/button-route.ts
		function routeButtonPress(input) {
		...
		//#endregion
		//#region src/client/turn-guard.ts
		...
		*/
		function meaningfulTurn(text) {
			const unit = text.trim().replace(/[，。！？、,.!?\s]/g, "");
		...
		function isRestartEcho(lastTurn, lastTurnAt, chunk, now) {
		...
		*/
		async function startPcmCapture(options) {
			...
			*  （isSilentPeak）在段级继续兜底真实无声，这里只负责「链路是否产出过数据」。 */
			...
			function onMessage(event) {
				...
				if (!probeDone && !muted) probePeak = Math.max(probePeak, peakAbs(pcm));
				options.onFrame(pcm);
			}
			try {
		...
		function createEnergyVad(sampleRate, tuning, events, floor) {
			const windowSamples = Math.max(1, Math.round(sampleRate * 20 / 1e3));
			const prerollWindows = Math.max(0, Math.round(tuning.prerollMs / 20));
			const silenceWindows = Math.max(1, Math.round(tuning.silenceMs / 20));
			const minSpeechWindows = Math.max(1, Math.round(tuning.minSpeechMs / 20));
			const maxSegmentWindows = Math.max(minSpeechWindows + 1, Math.round(tuning.maxSegmentMs / 20));
		...
		function quantileOf(buf, sorted, len, quantile) {
			if (len === 0) return 0;
			...
			return sorted[Math.min(len - 1, Math.max(0, Math.floor(len * quantile)))] ?? 0;
		}
		...
		function createRmsFloorEstimator(tuning = DEFAULT_RMS_FLOOR_TUNING) {
			...
			const floor = () => quantileOf(buf, sorted, len, tuning.quantile);
			return {
				observe,
				get floor() {
					return floor();
		...
		* 网络上行慢于采集时队列有界，满了丢最旧帧——实时音频无重放价值，保新不保旧。 */
		...
		function createCloudRealtime(tuning, events, deps) {
			...
			const onProviderEvent = (ev) => {
				...
				if (ev.type === "error") {
					failures += 1;
					if (ev.code === "events-unavailable" || failures >= CLOUD_FAIL_LIMIT) failNow(ev.code || "provider-unreachable");
					return;
				}
				if (paused) return;
		...
		*/
		function parseSseBlocks(buffer, chunk) {
			...
			while ((nl = buf.indexOf("\n\n")) >= 0) {
				...
				let event = "message";
				for (const line of lines) if (line.startsWith("event:")) event = line.slice(6).trim();
				for (const line of lines) if (line.startsWith("data: ")) events.push({
					event,
					data: line.slice(6)
				});
			}
		...
		*/
		...
		function createQueueRunner(deps) {
			const queue = [];
			let token = 0;
			let pending = false;
			let drain = null;
		...
		function createSpeechSynthesisSink(tuning) {
			...
			*  门控永远等不到 drain，麦克风还不回来）。 */
			const clearWatchdog = (owner = null) => {
		...
		*/
			...
			const runner = createQueueRunner({
				play(text) {
					return (async () => {
						...
						if (disposed || my !== utteranceGen || data.ok !== true || data.audio === void 0) return;
						...
						await new Promise((resolve) => {
							...
							playTimer = setTimeout(() => {
								...
								finishPlay();
							}, Math.max(2e3, Math.ceil(frames / 16e3) * 1e3 + 1500));
						});
		...
		//#endregion
		//#region src/client/voice-chat.tsx
		...
		*  这个数字与 styles.ts 的 caption 宽度是一对，改一处要同时看另一处。 */
		...
		const subscribeEnabled = (fn) => subscribeConfig(fn);
		const readEnabled = () => config.realtime.enabled;
		function useRealtimeEnabled() {
			return react.useSyncExternalStore(subscribeEnabled, readEnabled);
		}
		/** 只保留尾部字符，供单行字幕显示长回复。 */
		function tailText(text) {
			const flat = text.replace(/\s+/g, " ").trim();
			return flat.length > CAPTION_TAIL_CHARS ? `…${flat.slice(-40)}` : flat;
		}
		...
		function useVoiceChat(props) {
			...
			* 不许用户每次手动切引擎。 */
			const fallbackEngineRef = react.useRef(null);
			/** 跨 begin() 传递的提示（降级提示要先于 begin 决定、又不能被 begin 的 notice 覆盖）。 */
			const fallbackNoticeRef = react.useRef(null);
			...
			const canStartRef = react.useRef(props.canStart);
			...
			teardownRef.current = () => {
				if (phaseRef.current !== "idle") endSession();
			};
			react.useEffect(() => {
				if (!enabled) teardownRef.current();
			}, [enabled]);
			...
			const commitTurn = (text) => {
				...
				let merged = text;
				if (config.behavior.textMode === "append") merged = appendDraftText(draftRef.current, text);
			...
			const activeEngine = () => fallbackEngineRef.current ?? tuningRef.current?.engine ?? "browser";
			...
			*  归到云端通道文案，不再落进 Web Speech 兜底。 */
			const failMessage = (code) => {
				if (code === "no-mic" || code === "mic-denied" || code === "silent-device" || code === "no-audio-context") return t("errNoMic");
				if (code === "network") return t("errWebSpeechNetwork");
				if (code === "no-worklet" || code === "capture-failed") return t("errSegmentedUnsupported");
				if (code === "provider-closed" || code === "provider-timeout" || code === "transcription-failed" || code === "socket-closed") return t("errRealtimeProvider");
				if (code === "provider-unreachable" || code === "events-unavailable") return activeEngine() === "cloud" ? t("errRealtimeProvider") : t("errSegmentedUnreachable");
			...
			const failByCode = (code) => {
				if (code === "network" && fallbackEngineRef.current === null && tuningRef.current?.engine === "browser" && cloudConfigured()) {
					...
					endSession(void 0, void 0);
					fallbackNoticeRef.current = t("chatWebSpeechFallback");
					begin();
					return;
				}
				endSession(void 0, failMessage(code));
			};
			...
			const toggle = () => {
				if (phaseRef.current === "idle") {
					if (canStartRef.current !== void 0 && !canStartRef.current()) return;
			...
			const title = phase === "idle" ? sys.chatTitle : phase === "listening" ? sys.chatListeningTitle : phase === "thinking" ? sys.chatThinkingTitle : sys.chatSpeakingTitle;
			const ariaLabel = phase === "idle" ? t("chatTitle") : phase === "listening" ? t("chatListeningTitle") : phase === "thinking" ? t("chatThinkingTitle") : t("chatSpeakingTitle");
			...
			return {
				...
				status: (() => {
					...
					if (notice !== null) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: "dshav-hotkey-hint",
						"data-kind": "notice",
						role: "status",
						children: [
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshav-sr-only",
								children: phase === "listening" ? t("chatListeningTitle") : phase === "thinking" ? t("chatThinkingHint") : t("chatSpeakingHint")
							}),
		...
		*/
		...
		function VoiceButton(props) {
			...
			const previewConfirmRef = react.useRef(null);
			...
			const chatToggleRef = react.useRef(() => {});
			const longPressRef = react.useRef(null);
			if (longPressRef.current === null) longPressRef.current = createLongPressGate({
				thresholdMs: 450,
			...
			const instance = react.useMemo(() => ({
				...
				releaseHold: () => {
					if (stateRef.current === "recording") handlersRef.current.finish();
				},
			...
			const showError = (code, detail) => {
				...
				const msg = (() => {
					switch (code) {
						case "mic-denied":
						case "no-mic": return t("errNoMic");
						case "recorder-start-failed":
						case "recorder-unsupported": return t("errRecorderStart");
						case "no-speech-support": return t("errNoSpeechSupport");
						case "network": return t("errWebSpeechNetwork");
						case "cloud-not-configured": return t("errCloudNotConfigured");
						case "optimize": return `${t("errOptimize")}${detail ? `: ${detail}` : ""}`;
						default: return `${t("errTranscribe")}${detail ? `: ${detail}` : ""}`;
					}
				})();
				setError(msg);
				setNotice(null);
			...
			const handleTranscribed = (text) => {
				...
				if (config.optimize.mode === "llm") {
					...
					insertedRef.current = finalize(clean || cleaned);
			...
			*  返回实际写入草稿的字符串（append 模式下 = existing + sep + text）。 */
			const finalize = (text) => {
				...
				if (inputActions) {
					if (config.behavior.textMode === "append") text = appendDraftText(draftRef.current, text);
				...
				if (config.behavior.copyToClipboard) try {
					...
					if (writing !== void 0) writing.catch(() => {
			...
			const sys = systemDict();
			const title = chat.active ? chat.title : busy ? state === "recording" ? sys.recordingTitle : state === "transcribing" ? sys.transcribingTitle : sys.optimizingTitle : chat.enabled ? sys.micTitleHoldChat : sys.micTitle;
			const ariaLabel = chat.active ? chat.ariaLabel : busy ? state === "recording" ? t("recordingTitle") : state === "transcribing" ? t("transcribingTitle") : t("optimizingTitle") : chat.enabled ? t("micTitleHoldChat") : t("micTitle");
			const ariaKeyName = (spec) => spec.replace(/\bCtrl\b/gi, "Control").replace(/\bCmd\b/gi, "Meta").replace(/\bAlt\b/gi, "Alt");
			const shortcut = chat.enabled && config.realtime.hotkey !== "" ? ariaKeyName(config.realtime.hotkey) : config.behavior.hotkey !== "" ? ariaKeyName(config.behavior.hotkey) : void 0;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						chat.active ? chat.phase === "listening" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecDot, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChatIcon, {}) : state === "recording" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RecDot, {}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MicIcon, {}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "dshav-tooltip",
							role: "tooltip",
							children: title
						}),
				...
				}), chatStatus !== null ? chatStatus : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [
					...
					busy && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						children: [
							state !== "recording" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: "dshav-sr-only",
								children: state === "transcribing" ? t("transcribingHint") : t("optimizingHint")
							}),
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							className: "dshav-button dshav-button-primary dshav-button-sm",
							onClick: onConfirm,
							children: config.behavior.autoSend ? t("previewConfirmSend") : t("previewConfirmDraft")
						})]
					})
				]
			})] });
		...
		* 永不注册——这正是此前设置卡消失的根因）。 */
		...
		function apply(ctx) {
			...
			ctx.slots.inject("plugins.bundle.config", () => ctx.slots.register({
				...
				key: PACKAGE_NAME,
				locale: NS
			}, (props) => react_jsx_runtime.jsx(VoiceSettingsCard, {
				t,
				view: props?.view
			})));
			ctx.inject([
