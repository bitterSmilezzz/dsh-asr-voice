...
export const CloudSchema = z.object({
    /** 多供应商列表（新 shape）。 */
    providers: z.array(CloudProviderSchema).default([]),
    /** 当前使用的供应商 id（空 = 取第一个）。 */
...
export const AsrVoiceSettingsSchema = z.object({
    ...
    realtime: z.object({
        ...
        /**
         * 云端实时 provider（仅 engine=cloud 生效）：'builtin' = 内置模拟（I3/I4 开发态，
...
export const DEFAULT_SETTINGS = {
    ...
    realtime: { enabled: true, engine: 'browser', provider: 'builtin', tts: 'browser', ttsVoice: 'Cherry', hotkey: '', turn: { settleMs: 900, tailMs: 300 }, maxSessionMs: 600_000, speech: { firstSentenceMinChars: 12, utteranceWatchdogMs: 60_000 } },
};
